...
export default function SliderTopM() {
    const [movies, setMovies] = useState([]);

    async function Getdata() {
        try {
            const response = await axios.get(`https://api.themoviedb.org/3/trending/movie/week?api_key=45d1e37abba3da0419528c6d2999dc63`);
